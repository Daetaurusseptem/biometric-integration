...
router.get('/company/admins/all', Usuarios_1.UsuarioController.obtenerAdmins);
router.get('/company/admins/available', Usuarios_1.UsuarioController.obtenerAdminsDisponibles);
